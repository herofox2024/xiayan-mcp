...
# Test direct publishing with proper encoding
def test_publish_article():
    # Create article data with proper Chinese content
    article_data = {
        "articles": [{
            "title": "《活着》书评",
            "author": "文颜",
...
<p><strong>文颜书评</strong> —— 与好书相遇，与灵魂对话</p>
    ...
    # Convert to JSON with ensure_ascii=False to preserve Chinese characters
